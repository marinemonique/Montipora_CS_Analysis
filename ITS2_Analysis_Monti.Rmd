...
ind_coords_monti <- ind_coords_monti |>
  mutate("sample_name" = VialID) |> mutate(HostCluster = case_when(
    Axis1 < -5 ~ "MC1a",
...
#symbioant_monti_all <- all_data
#save(symbioant_monti_all, file = "symbioant_monti_all.RData")
```
